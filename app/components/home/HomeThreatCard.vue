  ...
  <section aria-labelledby="threat-stats-heading">
    <div class="mx-auto mb4 border rounded-md px4 pt4 lg:w-4xl sm:core-border sm:core-theme md:(px8 pt8)">
      <div class="mb-4 flex flex-col items-center justify-between rounded-lg bg-yellow-4 p-3 sm:mb-6 sm:flex-row sm:p-4">
        <h2 id="threat-stats-heading" class="mb-2 text-center text-xl text-black font-bold sm:mb-0 sm:text-left md:text-4xl sm:text-2xl">
          {{ t('home.stats.title') }}
        </h2>
      ...
      <div class="grid gap-3 md:grid-cols-2 sm:gap-4">
        ...
        <div class="rounded-lg bg-zinc-900 p-3 sm:p-4">
          ...
          <ul class="list-none p0 space-y-3">
            <li
            ...
            >
              <NuxtLink
                :to="breach.reference"
                class="relative grid grid-cols-[1fr,auto] items-start gap-2 no-underline"
                target="_blank"
              ...
              >
                <div class="min-w-0">
                  ...
                  <p class="mt-0.5 truncate text-xs text-black/80 font-semibold uppercase sm:text-sm">
                    {{ breach.subtext }}
                  </p>
                </div>
