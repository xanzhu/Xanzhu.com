    ...
    <nav aria-label="Resource navigation">
      ...
      >
        <li v-for="category in categoryLinks" :key="category.name" class="mb-2">
          <NuxtLink
            :to="category.path"
            class="focus:bg-neutral-8 hover:bg-neutral-8 text-sm px-2 py-1.5 rounded no-underline flex gap-2 transition-colors items-center hover:(text-white) focus:(outline-2 outline-white outline-offset-2)"
