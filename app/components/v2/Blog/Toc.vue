...
>
  ...
  <ul class="flex flex-col gap-2 px-6 text-sm" role="list">
    <li
      ...
      :key="link.id"
      class="text-gray-800 dark:text-light-400 transition-colors duration-200"
      :class="{
    ...
    >
      <NuxtLink
        class="no-underline font-mono text-inherit dark:text-inherit focus:outline-none focus:ring focus:ring-brand-dark focus:ring-opacity-50 dark:focus:ring-brand-light dark:focus:ring-opacity-50"
        :href="`#${link.id}`"
