...
<template>
  <main class="m0 h-screen flex flex-row items-center justify-center gap-16 bg-white text-black font-sans dark:(bg-black text-white)" :aria-label="errorLabel">
    <section class="max-w-lg">
      <h1 class="text-4xl font-semibold tracking-wide sm:text-6xl">
        {{ errorTitle }}
      </h1>

      <div class="mt-15 max-w-md core-border rounded-lg core-ui p-3 text-neutral8 dark:text-light2" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <aside class="hidden text-black lg:flex dark:text-white" aria-hidden="true">
      <svg
        v-if="errorCode === 404"
        width="356" height="356" viewBox="0 0 356 356" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
      ...
      <svg v-else width="326" height="326" viewBox="0 0 326 326" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
