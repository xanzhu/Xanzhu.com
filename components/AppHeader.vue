    ...
    <div class="dark:text-white text-black flex flex-col lg:hidden">
      ...
      >
        <NuxtLink
          ...
          :aria-label="t(link.name)"
          class="dark:hover:(bg-dark-600 text-white ease-in duration-75) hover:(bg-light-400) text-black dark:text-white rounded-sm font-medium text-white text-center py-2 px-3"
          v-t="link.name"
        />
      </nav>
    </div>
