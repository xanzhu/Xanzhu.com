<template>
  ...
  >
    ...
    >
      <NuxtLink
        :to="feature._path"
        class="text-black dark:(text-white) group flex flex-col lg:flex-row lg:items-center mx-auto space-y-3 md:py-9 lg:(p-0 space-x-8)"
      >
        <NuxtImg
        ...
        <div class="sm:(space-y-7) md:space-y-2 space-y-4 lg:max-w-xl">
          ...
          <p v-if="feature.description" class="font-thin opacity-80">
            {{ feature.description }}
          </p>
        </div>
      </NuxtLink>
