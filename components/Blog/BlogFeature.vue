<template>
  <div
    class="flex flex-col dark:(text-white bg-black) space-y-5 mx-auto items-center b-1 b-solid rounded-md dark:b-dark-700 b-gray-300 mb-10">
    <h2 class="text-2xl py-10">{{ $t('Home.release') }} 😊</h2>
    <div v-if="features" v-for="feature in features" :key="feature.title"
      ...
      <NuxtLink :to="feature._path"
        class="text-black dark:(text-white) no-underline group flex flex-col lg:flex-row lg:items-center mx-auto space-y-3 mb-10 md:py-9 lg:(p-0 space-x-8)">
