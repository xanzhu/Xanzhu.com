<template>
    <nav
        ...
        <NuxtLink v-if="prev" :to="prev._path"
            class="dark:(bg-black text-white) group dark:hover:bg-dark-900 hover:(bg-light-300 accent-color) flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true" class="md:mr-2 w-5 h-5"
                viewBox="0 0 20 20">
        ...
        <NuxtLink v-if="next" :to="next._path"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true" class="md:ml-2 w-5 h-5"
                viewBox="0 0 20 20">
                <path fill-rule="evenodd"
