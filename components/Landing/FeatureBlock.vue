<template>
  <div class="flex flex-col dark:(text-white bg-black) space-y-5 mx-auto">
    <div
      class="flex flex-col lg:(space-x-0 space-y-3 justify-between flex-row items-center pb-12) space-y-10 p-6"
    >
      <div class="flex flex-col space-y-2">
        ...
        <p
          class="dark:(text-gray-300) text-black text-md break-words lg:mr-[49%] font-thin tracking-wide"
        >
    ...
    <div
      ...
      :key="wide.title"
      class="sm:(mx-5 p-0) lg:mx-20 p-4"
    >
      <NuxtLink
        :to="wide._path"
      ...
      >
        ...
        <NuxtImg
          ...
          class="border-outline md:max-w-2xl"
          height="1253"
          width="1880"
        />
    ...
    <section
      class="grid grid-cols-1 gap-10 md:(grid-cols-2) p-4 sm:p-5 lg:p-20"
    >
      <div
        v-if="features"
