<template>
    <header
        class="md:(grid-cols-2 border-outline bg-light-600 dark:bg-dark-900 space-y-0) m-4 grid grid-cols-1 place-items-center gap-4 space-y-5">
        <div class="col-span-1 shrink-0 space-y-2 md:ml-4">
        ...
        <div class="relative col-span-1 grow-0">
            <div>
                ...
                <div v-if="post.source"
                    ...
                    <p v-t="'article.creditsource'" class="inline-block" />
                    : {{ post.source }}
                </div>
            </div>
        </div>
