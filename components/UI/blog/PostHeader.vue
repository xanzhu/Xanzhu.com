        ...
        <div class="relative col-span-1 grow-0">
            <div>
                ...
                <Date v-if="post.date" :date="post.date"
                    class="dark:(bg-black text-white) bg-white px-4 py-2 rounded-tl-none rounded-br-none rounded-tr-bl-[4px] border-l-1 border-b-1 border-gray-300 dark:border-dark-300 text-xs absolute top-0 right-0" />
