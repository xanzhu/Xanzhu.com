<template>
  <header class="flex text-dark-900 bg-transparent dark:(bg-black text-light-200) flex-wrap flex-row justify-between items-center md:space-x-4 mx-4 lg:mx-36 py-4">
    ...
    >
      ...
      <div class="mb-4 md:mb-0">
        ...
        <div v-show="TranslateMenu" class="z-4 absolute flex-row justify-end rounded-md dark:(bg-dark-600 text-light-200) bg-light-700 text-dark-900 p-1 md:shadow-md">
