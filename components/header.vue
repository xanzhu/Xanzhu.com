<template>
  <header class="flex text-dark-900 bg-transparent dark:(bg-black text-light-200) flex-row justify-between items-center  md:(space-x-4 mx-6 py-4) mx-4 lg:mx-12 xl:mx-22 py-2" role="banner">
