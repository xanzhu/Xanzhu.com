...
침해는 정기적으로 발생하며, 자신을 확인하는 것뿐만 아니라 발생 시 알림을 받는 것도 중요합니다. 사용할 수 있는 인기 있는 무료 서비스는 :PageLink{title="HaveIBeenPwned" url="https://haveibeenpwned.com/"} 입니다. 호주 보안 전문가인 Troy Hunt가 관리하는 이 웹사이트에서는 이메일 주소를 입력하고 위반 여부를 확인할 수 있습니다. 무언가를 찾으면 서비스로 이동하여 비밀번호를 업데이트하십시오.
...
alt: Bitwarden 암호 관리자 로고
---
::

사용할 수 있는 최고의 무료 암호 관리자 중 하나는 Bitwarden입니다. 옵션과 기능을 늘리는 유료 요금제를 제공하지만 대부분의 사용자에게는 :PageLink{title="무료 요금제" url="https://bitwarden.com/pricing/"} 로도 충분합니다.
...
자세한 내용은 :PageLink{title="bitwarden.com" url="https://bitwarden.com/"} 의 Bitwarden 웹사이트를 방문하십시오.
...
Keepass에 대한 자세한 내용은 :PageLink{title="keepass.info" url="https://keepass.info/"} 웹사이트를 참조하세요.
...
브라우저 기반 비밀번호 관리자에 대한 자세한 내용은 Google 비밀번호 관리자 웹사이트를 참조하세요. :PageLink{title="passwords.google.com" url="https://passwords.google.com/"}
...
alt: 유료 Password Manager 로고 Dashlane, NordPass, 1비밀번호
---
::
...
Dashlane은 기본 수준의 암호 관리를 제공하는 14일 동안의 무료 평가판을 제공합니다. :PageLink{title="스타터 플랜" url="https://www.dashlane.com/pricing"} 은 다크 웹에서 도난당한 콘텐츠를 추적하는 기능과 같은 몇 가지 유용한 기능을 제공합니다. 이 서비스는 다크 웹에서 자격 증명을 노출했을 수 있는 침해를 검색하여 일치하는 것이 있으면 보고서를 제공합니다.
...
Dashlane과 해당 기능에 대해 자세히 알아보려면 :PageLink{title="dashlane.com" url="https://www.dashlane.com"} 웹사이트를 방문하세요.
보안 및 개인 정보 보호와 관련하여 다크 웹 검색 기능이 있는 암호 관리자를 사용하는 것이 좋습니다. 자격 증명을 모니터링하고 다크 웹에 나타날 경우 경고를 받을 수 있기 때문입니다.

### NordPass

NordPass는 프리미엄 버전의 30일 무료 평가판과 함께 제공되는 매우 제한적이고 기본적인 :PageLink{title="무료 요금제" url="https://nordpass.com/plans/"} 를 제공합니다. 유료 요금제와 무료 요금제의 주요 차이점은 무료 요금제는 암호 관리자의 기본 기능만 제공하는 반면 유료 요금제는 다음과 같은 추가 기능을 제공한다는 것입니다.
...
NordPass 및 그 기능에 대해 자세히 알아보려면 :PageLink{title="nordpass.com" url="https://nordpass.com"} 웹사이트를 방문하십시오.

### 1Password

1Password는 :PageLink{title="프리미엄 요금제" url="https://1password.com/sign-up/"} 에 대한 무료 평가판을 제공합니다. 이 솔루션은 잘 설계되었으며 데스크톱 및 모바일을 포함한 모든 장치에서 작동합니다. 1Password는 무제한 장치를 제공하며 "여행 모드"라는 고유한 기능을 제공합니다. 이 기능은 여행 중에 장치에서 민감한 데이터를 제거하여 이동 중에 암호와 계정이 손상되지 않도록 합니다. 또한 반품 시 원클릭 복원 솔루션을 허용합니다.
...
1Password 및 그 기능에 대해 자세히 알아보려면 :PageLink{title="1password.com" url="https://1password.com"} 웹사이트를 방문하십시오.
