...
虽然这在用户体验方面不是最好的，但由于首次打开时显示的弹出窗口和上下文菜单的数量，它可以完成工作并且速度相对较快。 该浏览器适用于所有平台，但除非您需要特定的工具或功能，否则我不会推荐它。 也许这个浏览器的一个好特性是 :PageLink{title="能够访问旧的 Internet Explorer" rel="noopener" url="https://www.bairesdev.com/blog/internet-explorer-history/"}.
