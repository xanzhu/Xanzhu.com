...
非常 :PageLink{title="有趣的概念" url="https://www.apple.com/apple-vision-pro/"}，感谢 Apple 做了一些完全不同但改变游戏规则的事情。 仅使用神经网络完成这项工作所需的处理过程就令人印象深刻，我很高兴看到这将在未来几年内如何适应和改进。
...
:PageLink{title="刷新" url="https://www.apple.com/mac-studio/"} 使用下一代芯片组 M2 Max（12 核）和新的 M2 Ultra 24 核 性能大幅提升。 适用于视频编辑、3D 模型等行业标准任务。
...
疯狂的 :PageLink{title="性能改进" url="https://www.apple.com/mac-pro/"} ，这款新的高性能机器使用新的 M2 Ultra 芯片，性能提升 7.6 倍 英特尔版本。
...
:PageLink{title="支持的设备" url="https://www.apple.com/ios/ios-17-preview/"}:
