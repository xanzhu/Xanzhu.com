    ...
    <article v-if="post">
      <header class="dark:bg-dark-700 bg-light-700 mb-auto rounded-md flex flex-row">
        <div class="flex flex-col flex-1 p-4">
          ...
          <div class="text-2xl font-sans font-semibold mr-6 mb-auto">
            {{ post.title }}
          </div>
        ...
        <div class="flex flex-1 justify-end items-center h-36 ml-auto overflow-hidden rounded-md">
          <img class="h-auto w-auto" :src="post.media">
        </div>
      </header>
