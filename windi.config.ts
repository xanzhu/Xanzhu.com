...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "nav-internal":
      "p-2 rounded-md dark:hover:bg-dark-600 hover:bg-light-700 md:(hover:border-[#FF0000] border-b-2 border-transparent rounded-none hover:bg-transparent dark:hover:bg-transparent p-0)",
    "btn-prev-next":
